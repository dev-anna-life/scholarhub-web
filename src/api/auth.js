...
export const redeemAirtime = (amount, network, phone) => API.post('/shop/redeem-airtime', { amount, network, phone })
export const redeemData = (planId, network, phone) => API.post('/shop/redeem-data', { planId, network, phone })