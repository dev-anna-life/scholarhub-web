...
export const verifyOTPAndSignup = (data) => API.post('/auth/verify-otp-and-signup', data)
export const requestPasswordResetOTP = (email) => API.post('/auth/forgot-password', { email })
export const confirmResetPasswordWithOTP = (data) => API.post('/auth/reset-password', data)
